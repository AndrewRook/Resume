...
{\bf Principal Data Scientist}\hfill\mbox{2014-Present}\\
Capital One Labs
\vspace*{0.01 in}\begin{itemize} \itemsep -2pt
  \item Developed a novel approach to deliver internal technical
    trainings, providing over 5000 hours of classes with no instructors.
  \item Built a credit card payment simulator, allowing a product team
    to gain actionable insights without expensive pilots.
  \end{itemize}
\vspace{-0.15in}
...
The Data Incubator
                  \vspace* {0.01 in}\begin{itemize} \itemsep -2pt
                    \item Trained a model on
                      ...
                      delay times.
                    \item Designed a web interface to simplify itinerary
...
\section{\centerline{\large SKILLS}}
                    {\bf Programming:} Python, shell scripting, C++.\\
                      {\bf Databases and Web Design:} Django, AWS,
                      MySQL, Hive/Beeline.\\
                        {\bf Operating Systems:} Linux, Mac OS X.\\
                        {\bf Data Analysis:} Parallel and distributed
                        computing; machine
                        learning; image
                        processing and machine vision; Monte Carlo; principal component analysis.\\
