...
%                     in 1 month.
                  ...
                  %  \item Architected a genetic
                  %    algorithm in C++ to fit complex models to
                  %    high-resolution images.
                  % \item Built analysis software using C++ and shell
                  %   scripts to automatically compute descriptive
                  %   statistics for over 200 astronomical objects from
                  %   raw survey data.
                  % \item Computed descriptive statistics for
