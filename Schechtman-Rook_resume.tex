...
\section{\centerline{\large TECHNICAL SKILLS}}
                    ...
                    {\bf Model Development \& Deployment:} GBMs, random forests, linear \& logistic regression, \nobreak{nonlinear} optimization, genetic algorithms, parallel \& distributed computing, containerization, APIs\\
                      {\bf Databases, Orchestration, Web Design:}
                      Flask, Kubeflow Pipelines, MySQL/PostgreSQL, Prefect, Snowflake\\
...
\begin{itemize} \itemsep -1pt 
  ...
  \item Created a Python package to streamline data processing and feature engineering, currently
    used by over 100 analysts across multiple business-critical models.
