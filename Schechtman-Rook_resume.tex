...
\section{\centerline{\large TECHNICAL SKILLS}}
                    ...
                    sklearn, xgboost, matplotlib, pytorch), shell \nobreak{scripting}, Javascript, C++\\
                      ...
                      {\bf Cloud Computing/Devops:} AWS, Docker, CircleCI, Jenkins, GitHub Actions\\
                        {\bf Techniques:} Model interpretability, parallel and distributed computing, Monte Carlo, \nobreak{bootstrapping}, \nobreak{nonlinear} optimization\\
                        {\bf Data Analysis:} machine
                        learning, visualization, experimental design
\vspace{-0.1in}
